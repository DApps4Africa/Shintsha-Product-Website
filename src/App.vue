...
<v-app id="inspire">
    <v-app-bar app class="nav-header" flat dark>
        ...
        <v-toolbar-items class="hidden-sm-and-down">
            <v-btn v-for="item in menu" :key="item.title" :to="item.to" :href="item.to" text>{{ item.title }}</v-btn>
        </v-toolbar-items>
        <v-menu>
    ...
    <v-content class="text-center" style="max-width:'';" id="v_content">
        <v-flex class="row">
            <v-row class="above-the-fold">
                            ...
                            <div class="left-col-atf">
                                ...
                                <div class="cta-container">
                                    <div class="playstore-div">
                                        <v-tooltip top>
                                            <template v-slot:activator="{ on }">
                                                <a href="#popup1" class="cta-btn playstore-btn" v-on="on">
                ...
                <!--End Section 2 -->
                <!--Start Section 3 -->
                <v-col class="pad_top" id="use_cases">
                    <main id="btf-section" class="below-the-fold">
                        <section id="use-cases" class="why-our-app">
                            <div class="woa-wrap">
                                <div class="row-container">
                                    ...
                                    <div class="col-container-woa card_title_cutsom">
                                        <v-row align="center" justify="center">
                                            <v-col cols="12" sm="4" v-for="(usecase, i) in usecases" :key="i">
                                                <v-card class="mx-auto" width="400px" v-ripple="{ center: true }">
                                                    <v-img :src="usecase.img" height="300px" width="100%"></v-img>
                                                    <div class="text-xs-center">
                                                        <v-card-title style="width:100%; padding:0%;  display:inline-block; font-weight:bold;">
                                                            {{usecase.title}}
                                                        </v-card-title>
                                                    </div>
                                                    <v-divider></v-divider>
                                                    <v-card-text class="card_content" style="width:100%; font-weight:bold;  color: rgba(0, 0, 0, 0.70);">
                                                        {{usecase.text}}
                                                    </v-card-text>
                                                </v-card>
                                            </v-col>
    ...
    <v-row id="contact">
        <v-col class="pad_top">
            ...
            <v-footer dark padless>
                <v-card flat class=" nav-header lighten-1 white--text text-center" width="100%">
                    <v-card-text>
...
.app-header h2 {
    font-size: calc(30px + (45 - 40) * ((100vw - 320px) / (1200 - 320)));
    margin-bottom: 20px;
}
